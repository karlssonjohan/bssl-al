...
<code>Rscript dim_red.R 'C:/Users/erogeka/failed-for-test/_dtm' 2000 20 <path-to-common_Rscripts-directory> </code>
...
Path to common_Rscripts directory
...
Rscript bsl-modeling.R /path/to/topics.rda vis = TRUE/FALSE <path-to-common_Rscripts-directory> <path to labeled_logs.csv>

<code>Rscript bsl-modeling.R /home/etxjjkk/_logs/_collections/failed._seq._dtm._analysis TRUE . /home/etxjjkk/_logs/_collections/ </code>
...
Output: 
The posterior distributions of the model parameters are saved in <input dir>/bsl-model.rda
PDFs with plots. Also generates Rplots.pdf which can be ignored.


#### Non-Bayesian

Rscript sl-modeling.R  /path/to/topics.rda <path-to-common_Rscripts-directory> <path to labeled_logs.csv>



<code> Rscript sl-modeling.R /home/etxjjkk/_logs/_collections/failed._seq._dtm._analysis . /home/etxjjkk/_logs/_collections </code>
...
Rscript bssl-modeling.R /path/to/topics.rda vis = TRUE/FALSE <path-to-common_Rscripts-directory>  <path to labeled_logs.csv>


<code> Rscript bssl-modeling.R /home/etxjjkk/_logs/_collections/failed._seq._dtm._analysis TRUE . /home/etxjjkk/_logs/_collections </code>
...
<code> Rscript al.R /home/etxjjkk/_logs/_collections/failed._seq._dtm._analysis 'maxEntropy' /home/etxjjkk/_logs/_collections/labeled_logs.csv </code>
...
Rscript new_pred.R <path to new log dtm> <path to trained models> <model> <path-to-common_Rscripts-directory>

<code>Rscript new_pred.R 'C:\Users\etxjjkk\_logs\new-failed-log2._processedLogs._filtered._dtm' 'C:\Users\etxjjkk\_logs\w13a-w13b-w14a-w14b-failed-model-builds._processedLogs._filtered._dtm._analysis' bsl '<path-to-common_Rscripts-directory>' </code>
